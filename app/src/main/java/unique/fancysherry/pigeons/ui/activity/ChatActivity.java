...
public class ChatActivity extends ToolbarCastActivity implements EmojiconGridFragment.OnEmojiconClickedListener, EmojiconsFragment.OnEmojiconBackspaceClickedListener {
    ...
    FrameLayout emojiconsContainer;
    ...
    @OnClick({R.id.chat_other, R.id.chat_send, R.id.chat_emoji, R.id.chat_text, R.id.picture, R.id.file})
